...
func NewGrpcServer(ctx context.Context, txPool txPool, db kv.RoDB, chainID uint256.Int, isPulseChain bool) *GrpcServer {
	return &GrpcServer{ctx: ctx, txPool: txPool, db: db, NewSlotsStreams: &NewSlotsStreams{}, chainID: chainID, isPulseChain: isPulseChain}
}
